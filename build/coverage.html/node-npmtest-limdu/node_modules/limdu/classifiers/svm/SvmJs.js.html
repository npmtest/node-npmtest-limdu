...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-limdu/node_modules/limdu/classifiers/svm/SvmJs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-limdu/node_modules/limdu/classifiers/svm/SvmJs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-limdu/node_modules/limdu/classifiers/svm/</a> &#187; SvmJs.js</div>
</div>
<div class="body">
...
&nbsp;
SvmJs.prototype = {
	trainOnline :<span class="fstat-no" title="function not covered" >function(features, label) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error("svm.js does not support online training");</span>
	},
&nbsp;
...
&nbsp;
            ...
            var explanations = [];
            <span class="missing-if-branch" title="else path not taken" >E</span>if(this.base.usew_) {
              var w = this.base.w;
...
<span class="cstat-no" title="statement not covered" >    	return this.base.toJSON();</span>
    },
    
    fromJSON: <span class="fstat-no" title="function not covered" >function(json) {</span>
<span class="cstat-no" title="statement not covered" >    	this.base.fromJSON(json);</span>
    },
};
&nbsp;
&nbsp;
