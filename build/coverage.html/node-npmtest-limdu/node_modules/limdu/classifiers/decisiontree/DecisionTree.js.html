...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-limdu/node_modules/limdu/classifiers/decisiontree/DecisionTree.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-limdu/node_modules/limdu/classifiers/decisiontree/DecisionTree.js</span></h1>
    <h2>
        
        Statements: <span class="metric">85.33% <small>(64 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">62.5% <small>(5 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">75.86% <small>(22 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">87.3% <small>(55 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-limdu/node_modules/limdu/classifiers/decisiontree/</a> &#187; DecisionTree.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* Implementation of Decision Tree classifier, ID3 implementation
...
<span class="cstat-no" title="statement not covered" >			this.root = json</span>
		},
&nbsp;
		createTree: function(dataset, features) {
			...
			if (targets.length == 1){
        	 ...
        	 <span class="missing-if-branch" title="if path not taken" >I</span>if(features.length == 0){
                // console.log("returning the most dominate feature!!!");
<span class="cstat-no" title="statement not covered" >                var topTarget = this.mostCommon(targets);</span>
<span class="cstat-no" title="statement not covered" >                return {type:"result", val: topTarget, name: topTarget, alias: topTarget+this.randomTag()};</span>
        	}
...
&nbsp;
		mostCommon: <span class="fstat-no" title="function not covered" >function(l) {</span>
<span class="cstat-no" title="statement not covered" >        	return  _.sortBy(l,<span class="fstat-no" title="function not covered" >function(a){</span> <span class="cstat-no" title="statement not covered" >return this.count(a,l); </span>},this).reverse()[0];</span>
		},
&nbsp;
		count: <span class="fstat-no" title="function not covered" >function(a, l) {</span>
<span class="cstat-no" title="statement not covered" >        	return _.filter(l,<span class="fstat-no" title="function not covered" >function(b) {</span> <span class="cstat-no" title="statement not covered" >return b === a}</span>).length</span>
		},
&nbsp;
		randomTag: function() {
		...
		classify: function(features, explain, continuous_output) {
            ...
            while (root.type !== "result") {
                ...
                var sampleVal = features[attr];
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (childNode) {
                                root = childNode.child;
                        } else {
<span class="cstat-no" title="statement not covered" >                                root = root.vals[0].child;</span>
                        }
                }
            return root.val;
		},
